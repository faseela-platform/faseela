...
export interface Page {
  ...
  title: string;
  /**
   * Lowercase Latin letters and hyphens, e.g. about-us
   */
  slug: string;
  summary?: string | null;
  body: {
...
export interface Media {
  id: number;
  /**
   * A short Arabic description of what the image shows, for screen readers.
   */
  alt: string;
  credit?: string | null;
  updatedAt: string;
...
export interface Announcement {
  ...
  /**
   * Slug of a related Track, if any. Example: qiraa-2026
   */
