...
/**
 * The mark's gradient stops — logo 6a, ADR 0029. Converted from the designed hex with
 * culori at four decimals so `native.ts` round-trips exactly. Display colours only.
 */
export const logo: Record<LogoStop, string> = {
  "teal-hi": "oklch(0.7652 0.1396 175.24)",
  "teal-lo": "oklch(0.6169 0.1135 175.55)",
  "gold-hi": "oklch(0.8114 0.1346 90.03)",
  "gold-lo": "oklch(0.6645 0.118 88.68)",
  "teal-hi-night": "oklch(0.821 0.1423 176.63)",
  "teal-lo-night": "oklch(0.6998 0.1296 174.53)",
  "gold-hi-night": "oklch(0.8655 0.0939 88.56)",
  "gold-lo-night": "oklch(0.7447 0.1065 89.37)",
};
...
export const darkRoles = {
  ...
  brandDeep: seedling["100"],
  accent: stem["200"],
  accentFill: stem["300"],
  accentInk: stem["200"],
  tealHi: logo["teal-hi-night"],
  tealLo: logo["teal-lo-night"],
  goldHi: logo["gold-hi-night"],
  goldLo: logo["gold-lo-night"],
} as const;
