...
the *perceived* rhythm requires the larger number.
...
```css
[lang="en"] .eyebrow { letter-spacing: 0.06em; }
```
...
```css
.tag:lang(ar) { text-box: trim-both text text; }
```
